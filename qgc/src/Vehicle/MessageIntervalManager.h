...
public:
    ...
    /// Bulk-configures high-rate telemetry for key flight-critical messages on the
    /// autopilot component.  Intended to be called once immediately after vehicle
    /// connection so that attitude, position, and IMU data arrive at 10 Hz.
    void configureHighRateTelemetry();
